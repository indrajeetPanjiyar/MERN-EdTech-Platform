        ...
        <div className="bg-richblack-800">
            <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-400 leading-6 mx-auto relative py-14">
                ...
                <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblack-700">
                    ...
                    <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
                        ...
                        <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-3 lg:mb-7 lg:pl-0">
                                ...
                                {["About", "Careers", "Affiliates"].map( (element, index) => {
                                    return (
                                        ...
                                        className="text-[14px] cursor-pointer hover:text-richblack-50 transition-all duration-200">
                                            <Link to={element.toLocaleLowerCase() === "about" ? "/about" : `/${element.toLowerCase()}`}>{element}</Link>
                                        </div>
                                    )
                                })}
                            </div>
                        ...
                        <div className="w-[48%] lg:w-[30%] mb-3 lg:mb-7 lg:pl-0">
                            <p className="text-richblack-50 font-semibold text-[16px]">
                                Resources
                            </p>

                            <div className="flex flex-col gap-2 mt-2 lg:mb-7">
                        ...
                        <div className="w-[48%] lg:w-[30%] mb-3 lg:mb-7 lg:pl-0">
                            ...
                            <div className="flex flex-col gap-2 mt-2 mb-3 lg:mb-7">
                    ...
                    {/* Section 2 */}
                    <div className="lg:w-[50%] flex flex-wrap flex-row justify-between pl-3 lg:pl-5 gap-3">{FooterLink2.map( (element, index) => {
                        return (
            ...
            <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-richblack-400 mx-auto  pb-14 text-sm">
                <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
                    ...
                    <div className="text-center">Made with ❤️ Indrajeet © 2025 EdTech</div>
                </div>
            </div>
